...
folder are mapped to the application's root namespace, 'CursoExtJS'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "CursoExtJS"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'CursoExtJS' in the same way
as `"CursoExtJS/sass/src"`.
